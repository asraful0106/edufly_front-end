    ...
    return (
        <div className='flex flex-col min-h-screen bg-[#eeeeee]'>
            ...
            <Modal open={postModal} onClose={() => setPostModal(false)}>
                <div className='h-[30rem] w-[35rem] overflow-y-auto'>
                ...
                {/* Post button */}
                <button className={`py-3 w-full rounded-lg mt-2 text-xl font-bold ${textInput.trim() || files.length > 0 ? "bg-[#1A77F2] text-white" : "bg-black/15"}`}>Post</button>
            </Modal>
            {/* ------------***-------------- */}
